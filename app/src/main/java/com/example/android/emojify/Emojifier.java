...
class Emojifier {
    ...
    private static void getClassifications(Face face) {
        ...
        Log.d(LOG_TAG, "getClassifications: isLeftEyeOpenProbability=" + isLeftEyeOpenProbability);
        Log.d(LOG_TAG, "getClassifications: isRightEyeOpenProbability=" + isRightEyeOpenProbability);
        Log.d(LOG_TAG, "getClassifications: isSmilingProbability=" + isSmilingProbability);
    }
}
